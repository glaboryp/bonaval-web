...
export const conventoMeta = {
  ...
  ubicacion: [
    ...
    'El edificio se sitúa al nordeste de la ciudad, junto a la principal vía de entrada a la ciudad por el Camino Francés.',
  ],
  coordenadas: { lat: 42.88239, lng: -8.53774 },
  fundacionAtribuida: '1220 por Santo Domingo de Guzmán',
  templo:
    'Planta de cruz latina con tres naves de cinco tramos, la central de mayores dimensiones, que rematan en otras tantas capillas absidiales de planta poligonal, y un transepto.',
  usosActuales: [
    'Museo do Pobo Galego',
    'Panteón de Galegos Ilustres',
    'Parque público en antiguos huertos',
  ],
  estilos: [
    'Gótico mendicante (siglos XIII-XIV)',
    'Renacentista (elementos)',
    'Barroco compostelano (siglos XVII-XVIII)',
  ],
  patronos: ['Casa de Altamira', 'Arzobispo Antonio de Monroy'],
  arquitectosDestacados: ['Domingo de Andrade'],
  elementosSingulares: [
    'Triple escalera helicoidal de tres espirales independientes',
    'Claustro con artificio óptico para cuadrar planta trapezoidal',
    'Panteón de Gallegos Ilustres',
    'Fachada barroca con escudos y sartas de frutas',
  ],
}
...
export const cronologia = [
  {
    fecha: 1220,
    titulo: 'Tradición fundacional',
    texto: 'Fundado según la tradición en 1220 por Santo Domingo de Guzmán.',
  },
  {
    fecha: 'Siglo XIII',
    titulo: 'Primera construcción',
    texto:
      'Convento primitivo e iglesia, de los que se conservan el alzado del templo y restos escultóricos como el tímpano de la fachada principal, algunos capiteles del claustro, y seis cruces inscritas en círculos.',
  },
  {
    fecha: 'Siglos XIII-XIV',
    titulo: 'Ampliación de la iglesia',
    texto:
      'Se amplia la iglesia por la cabecera, utilizándose el espacio de las dos capillas laterales para construir el transepto.',
  },
  {
    fecha: 'Siglo XV',
    titulo: 'Capilla mayor',
    texto:
      'Se situaron en la capilla mayor cuatro sepulcros para los enterramientos de los condes de Altamira.',
  },
  {
    fecha: 'Siglo XVIII',
    titulo: 'Reconstrucción',
    texto:
      'Inicio de grandes reformas dirigidas por Domingo de Andrade bajo el patrocinio del arzobispo Antonio de Monroy. Estas obras supusieron una modificación de todo el templo.',
  },
  {
    fecha: 'Siglo XIX',
    titulo: 'Desamortización',
    texto:
      'Entró a formar parte de los bienes del municipio de Santiago, instalándose aquí un hospicio y un colegio para discapacitados',
  },
  { fecha: 1963, titulo: 'Museo municipal', texto: 'Se inaugura museo en parte del edificio.' },
  {
    fecha: 2015,
    titulo: 'Camino de Santiago',
    texto: 'Figura como elemento asociado en ampliación del Camino de Santiago.',
  },
]

export const panteon = {
  descripcion:
    'Capilla lateral que acoge restos de personalidades clave de la cultura e identidad de Galicia.',
  figuras: [
    {
...
export const curiosidades = [
  ...
  },
  {
    ...
    texto:
      'Juego de distancias en pilastras y arcos para “regularizar” una planta trapezoidal y percibir un cuadrado perfecto.',
  ...
  },
  {
    ...
    texto:
      'Tradición popular: fragmento de un antiguo púlpito conservado en la Cofradía del Rosario (sin confirmación documental).',
  ...
  },
  {
    ...
    texto:
      'El parque actual reutiliza antiguos huertos y cementerio: ejemplo de adaptación paisajística patrimonial.',
...
export const galeriaCreativeCommons = [
  {
    ...
    imagenes: ['/galeria/fachada.webp', '/galeria/fachada_2.webp', '/galeria/fachada_3.webp'],
  },
  {
    titulo: 'Ábside',
    img: '/galeria/abside.webp',
    imagenes: ['/galeria/abside.webp', '/galeria/abside_2.webp'],
  },
  {
    titulo: 'Claustro',
...
export const bibliografia = [
  {
    nombre: 'Arteguias',
    url: 'https://www.arteguias.com/convento/conventosantodomingobonavalsantiago.htm',
  },
  {
    nombre: 'Santiago Turismo',
    url: 'https://www.santiagoturismo.com/monumentos/igrexa-e-convento-de-san-domingos-de-bonaval',
  },
